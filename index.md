...
If the BrainFuck interpreter `bf.py`  is a bit hairy to look at, you can check out the [`step_by_step`](https://github.com/alexprengere/PythonBrainFuck/tree/master/step_by_step) folder to go from the simplest interpreter, then a bit better, then
